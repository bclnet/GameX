...
//using static OpenX.Gfx.OpenGL.GLCamera;

//namespace OpenX.Wpf.Control;

//public class GLControl : OpenTK.GLControl.GLControl {
...
//    protected virtual void HandleInput(MouseState mouseState, KeyboardState keyboardState) { }
