...
from openx.engines.panda3d.gfx.panda3d import GodotCellBuilder
...
class TextureRenderer(Renderer):
    ...
    def start(self):
        ...
        tex = self.gfxModel.textureManager.create(self.obj, None)[0]
    ...
    #     self.gfxModel.textureManager.reload(obj)
