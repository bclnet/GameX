...
from openx.gfx.egin import AABB
from openx.engines.panda3d.gfx.panda3d import Panda3dCellBuilder
from openx.engines.panda3d.gfx.panda3dopenengine import Panda3dOpenEngine
...
class TextureRenderer(Renderer):
    ...
    def start(self):
        ...
        tex = asyncio.run(self.gfxModel.textureManager.create(self.source, self.obj, None))[0]
...
class ObjectRenderer(Renderer):
    ...
    def start(self) -> None:
        asyncio.run(self.gfxModel.objectManager.create(self.source, self.obj, True, None))
