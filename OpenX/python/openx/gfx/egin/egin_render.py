...
from openx.gfx import Renderer #, GfxShader
from openx.gfx.util import _throw, _np_normalize, _np_getTranslation4x4, _np_createScale4x4, _np_createLookAt4x4, _np_createPerspectiveFieldOfView4x4
...
class RenderMaterial:
    ...
    def render(self, shader: GfxShader) -> None: pass
