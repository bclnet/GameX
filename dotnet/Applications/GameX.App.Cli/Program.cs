...
namespace GameX.App.Cli {
    ...
    partial class Program {
        ...
        //static readonly string[] args02 = ["list", "-f", "Bethesda", "-u", "game:/Oblivion*.bsa#Oblivion"];
        //static readonly string[] args03 = ["list", "-f", "Bethesda", "-u", "file:///D:/T_/Oblivion/Oblivion*.bsa#Oblivion"];
        ...
        static void Main(string[] args) {
            ...
            //args = argsValveNull;
            Register();
            Parser.Default.ParseArguments<TestOptions, ListOptions, GetOptions, ImportOptions>(args)
            .MapResult(
