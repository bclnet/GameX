...
using ViewBase = Stride.Views.ViewBase;
...
namespace GameX.App.Explorer.Controls
{
    public class ViewStride : UserControl
    {
        ...
        public static readonly DependencyProperty GfxProperty = DependencyProperty.Register(nameof(Gfx), typeof(IOpenGfx), typeof(ViewStride),
            new PropertyMetadata((d, e) => (d as ViewStride).OnSourceChanged()));
        public static readonly DependencyProperty SourceProperty = DependencyProperty.Register(nameof(Source), typeof(object), typeof(ViewStride),
            new PropertyMetadata((d, e) => (d as ViewStride).OnSourceChanged()));
        public static readonly DependencyProperty TypeProperty = DependencyProperty.Register(nameof(Type), typeof(string), typeof(ViewStride),
            new PropertyMetadata((d, e) => (d as ViewStride).OnSourceChanged()));
