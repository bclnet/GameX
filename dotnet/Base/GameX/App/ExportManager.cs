...
{
    public static async Task ExportAsync(Family family, Resource resource, string filePath, int from, object option)
    {
    ...
    static async Task ExportPakAsync(string filePath, int from, object option, PakFile _)
    {
