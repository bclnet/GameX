...
/// </summary>
public enum OblivionHavokMaterial : uint { //:O
...
public enum Fallout3HavokMaterial : uint { //:F3
...
public enum SkyrimHavokMaterial : uint { //:S
...
/// </summary>
public enum OblivionLayer : byte { //:S
...
/// </summary>
public enum Fallout3Layer : byte { //:F3
...
/// </summary>
public enum SkyrimLayer : byte { //:S
...
/// </summary>
public enum MoppDataBuildType : byte { //:X
...
/// </summary>
public enum PixelFormat : uint { //:X
...
/// </summary>
public enum PixelTiling : uint { //:X
    TILE_NONE = 0,
    TILE_XENON = 1,
    TILE_WII = 2,
    TILE_NV_SWIZZLED = 3
...
/// Describes the pixel format used by the NiPixelData object to store a texture.
/// </summary>
public enum PixelComponent : uint { //:X
    COMP_RED = 0,
    COMP_GREEN = 1,
    COMP_BLUE = 2,
    COMP_ALPHA = 3,
...
/// </summary>
public enum PixelRepresentation : uint { //:X
    REP_NORM_INT = 0,
    REP_HALF = 1,
    REP_FLOAT = 2,
    REP_INDEX = 3,
...
/// </summary>
public enum PixelLayout : uint { //:M
...
/// </summary>
public enum MipMapFormat : uint { //:M
...
/// </summary>
public enum AlphaFormat : uint { //:M
...
/// </summary>
public enum TexClampMode : uint { //:M
...
/// </summary>
public enum TexFilterMode : uint { //:M
...
/// </summary>
public enum BillboardMode : ushort { //:X
...
/// </summary>
public enum StencilCompareMode : uint { //:X
    EST_NEVER = 0,                  // Always false. Ref value is ignored.
...
/// </summary>
public enum StencilAction : uint { //:X
...
/// </summary>
public enum StencilDrawMode : uint { //:X
...
/// </summary>
public enum ZCompareMode : uint { //:X
...
/// </summary>
public enum hkMotionType : byte { //:X
...
/// </summary>
public enum hkDeactivatorType : byte { //:X
...
/// </summary>
public enum hkSolverDeactivation : byte { //:X
...
/// </summary>
public enum hkQualityType : byte { //:X
...
/// </summary>
public enum TransformMember : uint { //:X
...
/// </summary>
public enum SymmetryType : uint { //:X
...
/// </summary>
public enum VelocityType : uint { //:X
...
/// </summary>
public enum CoordGenType : uint { //:M
...
/// </summary>
public enum MaterialColor : ushort { //:X
...
/// </summary>
public enum LightColor : ushort { //:X
...
/// </summary>
public enum ConsistencyType : ushort { //:X
...
/// </summary>
public enum SortingMode : uint { //:X
...
/// </summary>
public enum PropagationMode : uint { //:X
...
/// </summary>
public enum CollisionMode : uint { //:X
...
/// Bethesda Havok.
/// </summary>
public enum hkResponseType : byte { //:X
...
/// </summary>
public enum BSDismemberBodyPartType : ushort { //:X
    BP_TORSO = 0,                   // Torso
    BP_HEAD = 1,                    // Head
    BP_HEAD2 = 2,                   // Head 2
...
/// </summary>
public enum BSLightingShaderPropertyShaderType : uint { //:X
    Default = 0,
    EnvironmentMap = 1,             // Enables EnvMap Mask(TS6), EnvMap Scale
    GlowShader = 2,                 // Enables Glow(TS3)
    Parallax = 3,                   // Enables Height(TS4)
    FaceTint = 4,                   // Enables Detail(TS4), Tint(TS7)
    SkinTint = 5,                   // Enables Skin Tint Color
    HairTint = 6,                   // Enables Hair Tint Color
    ParallaxOcc = 7,                // Enables Height(TS4), Max Passes, Scale. Unimplemented.
    MultitextureLandscape = 8,
    LODLandscape = 9,
    Snow = 10,
    MultiLayerParallax = 11,        // Enables EnvMap Mask(TS6), Layer(TS7), Parallax Layer Thickness, Parallax Refraction Scale, Parallax Inner Layer U Scale, Parallax Inner Layer V Scale, EnvMap Scale
    TreeAnim = 12,
    LODObjects = 13,
    SparkleSnow = 14,               // Enables SparkleParams
    LODObjectsHD = 15,
    EyeEnvmap = 16,                 // Enables EnvMap Mask(TS6), Eye EnvMap Scale
    Cloud = 17,
...
/// </summary>
public enum EffectShaderControlledVariable : uint { //:X
    EmissiveMultiple = 0,           // EmissiveMultiple.
    FalloffStartAngle = 1,          // Falloff Start Angle (degrees).
    FalloffStopAngle = 2,           // Falloff Stop Angle (degrees).
    FalloffStartOpacity = 3,        // Falloff Start Opacity.
    FalloffStopOpacity = 4,         // Falloff Stop Opacity.
    AlphaTransparency = 5,          // Alpha Transparency (Emissive alpha?).
    UOffset = 6,                    // U Offset.
    UScale = 7,                     // U Scale.
    VOffset = 8,                    // V Offset.
    VScale = 9                      // V Scale.
...
/// </summary>
public enum EffectShaderControlledColor : uint { //:X
    EmissiveColor = 0               // Emissive Color.
}

/// <summary>
/// An unsigned 32-bit integer, describing which float variable in BSLightingShaderProperty to animate.
/// </summary>
public enum LightingShaderControlledVariable : uint { //:X
    RefractionStrength = 0,         // The amount of distortion.
    EnvironmentMapScale = 8,        // Environment Map Scale.
    Glossiness = 9,                 // Glossiness.
    SpecularStrength = 10,          // Specular Strength.
    EmissiveMultiple = 11,          // Emissive Multiple.
    Alpha = 12,                     // Alpha.
    UOffset = 20,                   // U Offset.
    UScale = 21,                    // U Scale.
    VOffset = 22,                   // V Offset.
...
/// </summary>
public enum LightingShaderControlledColor : uint { //:X
    SpecularColor = 0,              // Specular Color.
    EmissiveColor = 1               // Emissive Color.
}

/// <summary>
/// Bethesda Havok. Describes the type of bhkConstraint.
/// </summary>
public enum hkConstraintType : uint { //:X
    BallAndSocket = 0,              // A ball and socket constraint.
    Hinge = 1,                      // A hinge constraint.
    LimitedHinge = 2,               // A limited hinge constraint.
