...
public class FileManagerTests {
    ...
    [TestMethod]
    [DataRow("AC", "AC", "*.dat", 4)]
    [DataRow("Arkane", "AF", "*.arc", 7)]
    [DataRow("Arkane", "DOM", "*_dir.vpk", 9)]
    [DataRow("Arkane", "Radius", "*TOC.txt", 1)]
    [DataRow("Arkane", "D2", "*.Index", 28)]
    [DataRow("Arkane", "P", "*.arc", 14)]
    [DataRow("Arkane", "Radius:DOTO", "*.Index", 10)]
    ...
    [DataRow("Cry", "ArcheAge", "*.arc", 5)]
    [DataRow("Cry", "Hunt", "*.arc", 69)]
    [DataRow("Cry", "Warface", "*.arc", 51)]
    [DataRow("Cry", "Wolcen", "*.arc", 134)]
    [DataRow("Cry", "Crysis", "*.arc", 21)]
    [DataRow("Cry", "Ryse", "*.arc", 24)]
    [DataRow("Cry", "Robinson", "*.arc", 15)]
    [DataRow("Cry", "Snow", "*.arc", 7)]
