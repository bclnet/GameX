...
public static class TestHelper {
    ...
    public static readonly Dictionary<string, Lazy<Archive>> Paks = new()
    {
        ...
        { "Arkane:D", new Lazy<Archive>(() => familyArkane.GetArchive(new Uri("game:/*TOC.txt#D"))) },
        ...
        { "Arkane:D:DOTO", new Lazy<Archive>(() => familyArkane.GetArchive(new Uri("game:/*.Index#D:DOTO"))) },
