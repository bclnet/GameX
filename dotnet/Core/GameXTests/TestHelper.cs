...
public static class TestHelper {
    ...
    public static readonly Dictionary<string, Lazy<Archive>> Paks = new()
    {
        ...
        { "Red:Witcher", new Lazy<Archive>(() => familyRed.OpenArchive(new Uri("game:/*.key#Witcher"))) },
        { "Red:Witcher2", new Lazy<Archive>(() => familyRed.OpenArchive(new Uri("game:/*#Witcher2"))) },
        { "Red:Witcher3", new Lazy<Archive>(() => familyRed.OpenArchive(new Uri("game:/content0/*#Witcher3"))) },
        { "Red:CP77", new Lazy<Archive>(() => familyRed.OpenArchive(new Uri("game:/*.archive#CP77"))) },
        { "Rsi:StarCitizen", new Lazy<Archive>(() => familyRsi.OpenArchive(new Uri("game:/Sbi.p4k#StarCitizen"))) },
        { "Tes:Morrowind", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/Morrowind.bsa#Morrowind"))) },
        { "Tes:Oblivion", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/Oblivion*.bsa#Oblivion"))) },
        { "Tes:Skyrim", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/Skyrim*.bsa#Skyrim"))) },
        { "Tes:SkyrimSE", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/Skyrim*.bsa#SkyrimSE"))) },
        { "Tes:Fallout2", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/*.dat#Fallout2"))) },
        { "Tes:Fallout3", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/Fallout*.bsa#Fallout3"))) },
        { "Tes:FalloutNV", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/Fallout*.bsa#FalloutNV"))) },
        { "Tes:Fallout4", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/Fallout4*.ba2#Fallout4"))) },
        { "Tes:Fallout4VR", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/Fallout4*.ba2#FalloutVR"))) },
        { "Tes:Fallout76", new Lazy<Archive>(() => familyTes.OpenArchive(new Uri("game:/SeventySix*.ba2#Fallout76"))) },
        { "Valve:Dota2", new Lazy<Archive>(() => familyValve.OpenArchive(new Uri("game:/(core:dota)/*_dir.vpk#Dota2"))) },
    };
}
