...
public static class TestHelper {
    ...
    public static readonly Dictionary<string, Lazy<PakFile>> Paks = new()
    {
        ...
        { "Arkane:Radius", new Lazy<PakFile>(() => familyArkane.OpenPakFile(new Uri("game:/*TOC.txt#Radius"))) },
        ...
        { "Arkane:Radius:DOTO", new Lazy<PakFile>(() => familyArkane.OpenPakFile(new Uri("game:/*.Index#Radius:DOTO"))) },
