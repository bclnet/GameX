...
public class ViewInfo : Node {
    static ViewInfo() => EngineX.Activate(GodotEngine.This);
    ...
    public override void _Ready() {
        try {
            ...
            Renderer = GodotRenderer.CreateRenderer(this, EngineX.Gfx, Source, value, Type);
            Renderer?.Start();
        }
