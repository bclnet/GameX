...
//using OpenEngine.Gfx;
//using OpenEngine.Engine.Unity;
//using System;
//using System.Collections.Generic;
//using UnityEngine;
//using static OpenEngine.Debug;

//namespace GameX.Bethesda.Formats.Unity;

//public class NifObjectBuilder(Binary_Nif obj, IMaterialManager<Material, Texture2D> materialManager, int markerLayer)
//{
//    const bool KinematicRigidbodies = true;
//    readonly Binary_Nif _obj = obj;
//    readonly IMaterialManager<Material, Texture2D> _materialManager = materialManager;
//    readonly int _markerLayer = markerLayer;
