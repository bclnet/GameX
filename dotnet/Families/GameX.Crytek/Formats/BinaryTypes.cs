...
public struct IRGBA(byte r, byte g, byte b, byte a) {
    public const int SizeOf = sizeof(byte) * 4;
    [FieldOffset(0)] public byte r = r;              // red
    [FieldOffset(1)] public byte g = g;              // green
    [FieldOffset(2)] public byte b = b;              // blue
    [FieldOffset(3)] public byte a = a;              // alpha
    [FieldOffset(0)] public int value = 0;
}
