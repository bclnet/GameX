...
namespace GameX.IW.Formats {
    public unsafe static partial class FastFile {
                ...
                try {
                    switch (header.Version) {
                        ...
                        case FF_VERSION.BO3: {
                                ...
                                if (flagsPC != 0) throw new Exception("Invalid Fast File Engine. Only PC Fast Files are supported.");
        ...
        internal static List<FileHeader> GetAssets(BinaryArchive source, BinaryReader r, byte[] cryptKey, ref FF_Header header) {
