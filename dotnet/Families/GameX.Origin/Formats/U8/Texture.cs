...
public unsafe class Texture : IHaveMetaInfo, ITexture {
    ...
    public T Create<T>(string platform, Func<object, T> func) {
        ...
        //format = (Engine.Type)platform switch
        //{
        //    Engine.Type.OpenGL => Format.gl,
        //    Engine.Type.Unity => Format.unity,
        //    Engine.Type.Unreal => Format.unreal,
        //    Engine.Type.Vulken => Format.vulken,
        //    Engine.Type.StereoKit => throw new NotImplementedException("StereoKit"),
