...
partial class ColladaFileWriter {
    ...
    void SetLibraryControllers() {
        ...
        var vertexWeights = new Collada_Vertex_Weights {
            ...
            Input = [
                new Collada_Input_Shared { Semantic = Collada_Input_Semantic.JOINT, source = "#Controller-joints", Offset = 0 },
                new Collada_Input_Shared { Semantic = Collada_Input_Semantic.WEIGHT, source = "#Controller-weights", Offset = 1 }
            ]
        };
