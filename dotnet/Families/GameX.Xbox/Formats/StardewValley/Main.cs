...
public static class X {
    public static void Register() {
        {
            // enum
            Add(new TypeReader<Gender>("Gender", "StardewValley.Gender", r => new Gender()));
            Add(new TypeReader<Season>("Season", "StardewValley.Season", r => new Season()));
        }
        Add(new TypeReader<string>("BmFont.XmlSourceReader", "String", r => r.ReadLV7UString()));
        Add(new TypeReader<ModFarmType>("ModFarmType", "StardewValley.GameData.ModFarmType", r => new ModFarmType()));
        Add(new TypeReader<ModLanguage>("ModLanguage", "StardewValley.GameData.ModLanguage", r => new ModLanguage()));
        Add(new TypeReader<ModWallpaperOrFlooring>("ModWallpaperOrFlooring", "StardewValley.GameData.ModWallpaperOrFlooring", r => new ModWallpaperOrFlooring()));
        Add(new TypeReader<AudioCueData>("AudioCueData", "StardewValley.GameData.AudioCueData", r => new AudioCueData()));
        {
        ...
        Add(new TypeReader<BigCraftables.BigCraftableData>("BigCraftables.BigCraftableData", "StardewValley.GameData.BigCraftables.BigCraftableData", r => new BigCraftables.BigCraftableData()));
        Add(new TypeReader<Buffs.BuffData>("Buffs.BuffData", "StardewValley.GameData.Buffs.BuffData", r => new Buffs.BuffData()));
        {
            Add(new TypeReader<Buffs.BuffAttributesData>("Buffs.BuffAttributesData", "StardewValley.GameData.Buffs.BuffAttributesData", r => new Buffs.BuffAttributesData()));
        }
