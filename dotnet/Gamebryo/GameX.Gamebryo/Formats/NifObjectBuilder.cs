...
//public class NifObjectBuilder<Object, Material, Texture>(Binary_Nif source, IMaterialManager<Material, Texture> materialManager, bool isStatic)
//{
...
//    readonly IMaterialManager<Material, Texture> _materialManager = materialManager;
//    readonly bool _isStatic = isStatic;
//    readonly ModelApi<Object, Material> api;
...
//        if (shouldAddMissingColliders) api.AddMissingMeshCollidersRecursively(gobj, _isStatic);
//        if (isMarker) api.SetLayerRecursively(gobj, MarkerLayer);
//        return gobj;
//    }
...
//    {
//        var obj = api.CreateObject(node.Name);
...
//        var obj = api.CreateObject(triShape.Name);
//        var mesh = api.CreateMesh((NiTriShapeData)_source.Blocks[triShape.Data.Value]);
//        if (visual)
//        {
//            var materialProps = NiAVObjectToMaterialProp(triShape);
//            var material = _materialManager.CreateMaterial(materialProps).mat;
//            var enabled = materialProps.Textures != null && triShape.Flags.HasFlag(NiAVObject.NiFlags.Hidden);
//            api.AddMeshRenderer(obj, mesh, material, enabled, true);
//        }
//        if (collidable) api.AddMeshCollider(obj, mesh, KinematicRigidbody, _isStatic);
...
//    {
//        var obj = api.CreateObject("Root Collision Node");
...
//    void ApplyNiAVObject(NiAVObject niAVObject, Object obj) => api.Transform(obj, niAVObject.Translation / MeterInUnits, niAVObject.Rotation, niAVObject.Scale * Vector3.One);
...
//    MaterialPropStandard2 NiAVObjectToMaterialProp(NiAVObject obj)
//    {
...
//        var mp = new MaterialPropStandard2();
...
//    {
//        if (niObject.GetType() == typeof(NiTriShape)) api.SetParent(InstantiateNiTriShape((NiTriShape)niObject, false, true), obj);
