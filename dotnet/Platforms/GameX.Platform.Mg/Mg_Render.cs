...
public static class MgRenderer {
    public static Renderer CreateRenderer(object parent, IList<IOpenGfx> gfx, object obj, string type)
        => type switch {
            "TestTri" => new TestTriRenderer(gfx[XSprite2D] as MgGfxSprite2D, obj),
            "Texture" => new SpriteRenderer(gfx[XSprite2D] as MgGfxSprite2D, obj),
            //"Object" => new ObjectRenderer(gfx[XSprite2D] as MgGfxSprite2D, obj),
            _ => default
        };
}
