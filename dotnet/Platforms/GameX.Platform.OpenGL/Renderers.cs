...
{
    public static Renderer CreateRenderer(object parent, OpenGLGfxModel gfx, object obj, string type)
        => type switch
        {
...
public class OpenGLEngineRenderer(OpenGLGfxModel gfx, object obj) : Renderer { }
