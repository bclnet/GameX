...
namespace GameX.WB.Formats.AC.Props;
...
partial class PropertyExtensions
{
    public static string GetValueEnumName(this PropertyDataId property, uint value)
    {
        ...
        {
            PropertyDataId.ActivationAnimation or PropertyDataId.InitMotion or PropertyDataId.UseTargetAnimation or PropertyDataId.UseTargetFailureAnimation or PropertyDataId.UseTargetSuccessAnimation or PropertyDataId.UseUserAnimation => Enum.GetName(typeof(MotionCommand), value),
            PropertyDataId.PhysicsScript or PropertyDataId.RestrictionEffect => Enum.GetName(typeof(PlayScript), value),
            PropertyDataId.ActivationSound or PropertyDataId.UseSound => Enum.GetName(typeof(Sound), value),
            PropertyDataId.WieldedTreasureType or PropertyDataId.DeathTreasureType => null,
            PropertyDataId.Spell or PropertyDataId.DeathSpell or PropertyDataId.ProcSpell or PropertyDataId.RedSurgeSpell or PropertyDataId.BlueSurgeSpell or PropertyDataId.YellowSurgeSpell => Enum.GetName(typeof(SpellId), value),
            PropertyDataId.ItemSkillLimit or PropertyDataId.ItemSpecializedOnly => System.Enum.GetName(typeof(Skill), value),
            PropertyDataId.PCAPRecordedParentLocation => Enum.GetName(typeof(ParentLocation), value),
            PropertyDataId.PCAPRecordedDefaultScript => System.Enum.GetName(typeof(MotionCommand), value),
            _ => null,
        };
    }
...
partial class PropertyExtensions
{
    public static string GetValueEnumName(this PropertyInt property, int value) => property switch
    {
        PropertyInt.ActivationResponse => Enum.GetName(typeof(ActivationResponse), value),
        PropertyInt.AetheriaBitfield => Enum.GetName(typeof(AetheriaBitfield), value),
        PropertyInt.AttackHeight => Enum.GetName(typeof(AttackHeight), value),
        PropertyInt.AttackType => Enum.GetName(typeof(AttackType), value),
        PropertyInt.Attuned => Enum.GetName(typeof(AttunedStatus), value),
        PropertyInt.AmmoType => Enum.GetName(typeof(AmmoType), value),
        PropertyInt.Bonded => Enum.GetName(typeof(BondedStatus), value),
        PropertyInt.ChannelsActive or PropertyInt.ChannelsAllowed => Enum.GetName(typeof(Channel), value),
        PropertyInt.CombatMode => Enum.GetName(typeof(CombatMode), value),
        PropertyInt.DefaultCombatStyle or PropertyInt.AiAllowedCombatStyle => Enum.GetName(typeof(CombatStyle), value),
        PropertyInt.CombatUse => Enum.GetName(typeof(CombatUse), value),
        PropertyInt.ClothingPriority => Enum.GetName(typeof(CoverageMask), value),
        PropertyInt.CreatureType or PropertyInt.SlayerCreatureType or PropertyInt.FoeType or PropertyInt.FriendType => Enum.GetName(typeof(CreatureType), value),
        PropertyInt.DamageType or PropertyInt.ResistanceModifierType => Enum.GetName(typeof(DamageType), value),
        PropertyInt.CurrentWieldedLocation or PropertyInt.ValidLocations => Enum.GetName(typeof(EquipMask), value),
        PropertyInt.EquipmentSetId => Enum.GetName(typeof(EquipmentSet), value),
        PropertyInt.Gender => Enum.GetName(typeof(Gender), value),
        PropertyInt.GeneratorDestructionType or PropertyInt.GeneratorEndDestructionType => Enum.GetName(typeof(GeneratorDestruct), value),
        PropertyInt.GeneratorTimeType => Enum.GetName(typeof(GeneratorTimeType), value),
        PropertyInt.GeneratorType => Enum.GetName(typeof(GeneratorType), value),
        PropertyInt.HeritageGroup or PropertyInt.HeritageSpecificArmor => Enum.GetName(typeof(HeritageGroup), value),
        PropertyInt.HookType => Enum.GetName(typeof(HookType), value),
        PropertyInt.HouseType => Enum.GetName(typeof(HouseType), value),
        PropertyInt.ImbuedEffect or PropertyInt.ImbuedEffect2 or PropertyInt.ImbuedEffect3 or PropertyInt.ImbuedEffect4 or PropertyInt.ImbuedEffect5 => Enum.GetName(typeof(ImbuedEffectType), value),
        PropertyInt.HookItemType or PropertyInt.ItemType or PropertyInt.MerchandiseItemTypes or PropertyInt.TargetType => Enum.GetName(typeof(ItemType), value),
        PropertyInt.ItemXpStyle => Enum.GetName(typeof(ItemXpStyle), value),
        PropertyInt.MaterialType => Enum.GetName(typeof(MaterialType), value),
        PropertyInt.PaletteTemplate => Enum.GetName(typeof(PaletteTemplate), value),
        PropertyInt.PhysicsState => Enum.GetName(typeof(PhysicsState), value),
        PropertyInt.HookPlacement or PropertyInt.Placement or PropertyInt.PCAPRecordedPlacement => Enum.GetName(typeof(Placement), value),
        PropertyInt.PortalBitmask => Enum.GetName(typeof(PortalBitmask), value),
        PropertyInt.PlayerKillerStatus => Enum.GetName(typeof(PlayerKillerStatus), value),
        PropertyInt.BoosterEnum => Enum.GetName(typeof(PropertyAttribute2nd), value),
        PropertyInt.ShowableOnRadar => Enum.GetName(typeof(RadarBehavior), value),
        PropertyInt.RadarBlipColor => Enum.GetName(typeof(RadarColor), value),
        PropertyInt.WeaponSkill or PropertyInt.WieldSkillType or PropertyInt.WieldSkillType2 or PropertyInt.WieldSkillType3 or PropertyInt.WieldSkillType4 or PropertyInt.AppraisalItemSkill => Enum.GetName(typeof(Skill), value),
        PropertyInt.AccountRequirements => Enum.GetName(typeof(SubscriptionStatus), value),
        PropertyInt.SummoningMastery => Enum.GetName(typeof(SummoningMastery), value),
        PropertyInt.UiEffects => Enum.GetName(typeof(UIEffects), value),
        PropertyInt.ItemUseable => Enum.GetName(typeof(Usable), value),
        PropertyInt.WeaponType => Enum.GetName(typeof(WeaponType), value),
        PropertyInt.WieldRequirements or PropertyInt.WieldRequirements2 or PropertyInt.WieldRequirements3 or PropertyInt.WieldRequirements4 => Enum.GetName(typeof(WieldRequirement), value),
        PropertyInt.GeneratorStartTime or PropertyInt.GeneratorEndTime => DateTimeOffset.FromUnixTimeSeconds(value).DateTime.ToString(CultureInfo.InvariantCulture),
        PropertyInt.ArmorType => Enum.GetName(typeof(ArmorType), value),
        PropertyInt.ParentLocation => Enum.GetName(typeof(ParentLocation), value),
        PropertyInt.PlacementPosition => Enum.GetName(typeof(Placement), value),
        PropertyInt.HouseStatus => Enum.GetName(typeof(HouseStatus), value),
        PropertyInt.UseCreatesContractId => Enum.GetName(typeof(ContractId), value),
        PropertyInt.Faction1Bits or PropertyInt.Faction2Bits or PropertyInt.Faction3Bits or PropertyInt.Hatred1Bits or PropertyInt.Hatred2Bits or PropertyInt.Hatred3Bits => Enum.GetName(typeof(FactionBits), value),
        PropertyInt.UseRequiresSkill or PropertyInt.UseRequiresSkillSpec or PropertyInt.SkillToBeAltered => Enum.GetName(typeof(Skill), value),
        PropertyInt.HookGroup => Enum.GetName(typeof(HookGroupType), value),
        //PropertyInt.TypeOfAlteration => Enum.GetName(typeof(SkillAlterationType), value),
        _ => null,
    };
}
...
public class GenericPropertiesId<TAttribute> where TAttribute : Attribute
{
    ...
    static HashSet<TResult> GetValues<T, TResult>() => new(typeof(T).GetFields()
        .Select(x => new { att = x.GetCustomAttributes(false).OfType<TAttribute>().FirstOrDefault(), member = x })
...
public class GenericProperties<TAttribute> where TAttribute : Attribute
{
    ...
    /// <typeparam name="TResult">Type of the results</typeparam>
    static HashSet<T> GetValues<T>() => new(typeof(T).GetFields()
        .Select(x => new { att = x.GetCustomAttributes(false).OfType<TAttribute>().FirstOrDefault(), member = x })
