...
class OblivionHavokMaterial(Enum): #:O
...
class OblivionHavokMaterial(Enum): #:F3
...
class SkyrimHavokMaterial(Enum): #:S
...
class MoppDataBuildType(Enum): #:X
...
class PixelLayout(Enum): #:M
    LAY_PALETTISED_8 = 0,           # Texture is in 8-bit palettized format.
    ...
    LAY_PALETTISED_4 = 5,           # Texture is in 4-bit palettized format.
...
class StencilCompareMode(Enum): #:X
...
class HKDeactivatorType(Enum): #:X
...
class HKSolverDeactivation(Enum): #:X
...
class BSDismemberBodyPartType(Enum): #:X
    BP_TORSO = 0,                   # Torso
    BP_HEAD = 1,                    # Head
    BP_HEAD2 = 2,                   # Head 2
...
class BSLightingShaderPropertyShaderType(Enum): #:X
    Default = 0,
...
class EffectShaderControlledVariable(Enum): #:X
...
class EffectShaderControlledColor(Enum): #:X
...
class LightingShaderControlledVariable(Enum): #:X
