...
# from openx.gfx import ITexture, IRenderer
from gamex.engine_pygame_views import createView
...
# https://github.com/ParisNeo/QPanda3D/blob/master/QPanda3D/Panda3DWorld.py
