...
class TES3Record(Record):
    ...
    def createField(self, r: Header, type: FieldType, dataSize: int) -> object:
        match type:
            case FieldType.HEDR: return setattr(self, 'HEDR', self.HEDRField(r, dataSize))
            case FieldType.MAST: return setattr(self, 'MASTs', addX(self.MASTs, readSTRV(r, dataSize)))
            case FieldType.DATA: return setattr(self, 'DATAs', addX(self.DATAs, readINTV(r, dataSize)))
            case _: return Record.empty
