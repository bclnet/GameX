...
def dataRow(key: str, path: str, file: str) -> None:
    ...
    with open(path, 'rb') as fs:
        ...
        for ent in pak.infolist()[:10]: log(f'{ent.filename} - {ent.compress_type}')
        if file:
...
## None (OK)
#dataRow(null,
#    r"G:\SteamLibrary\steamapps\common\Crysis Remastered\Game\gamedata.pak", r"xxx");

# P4K (OK)
# dataRow("hex:5E7A2002302EEB1A3BB617C30FDE1E47",
#     r"D:\Roberts Space Industries\StarCitizen\LIVE\Data.p4k", r"Data\Prefabs\shops\admin\admin.xml")
# dataRow("hex:5E7A2002302EEB1A3BB617C30FDE1E47",
#     r"D:\Roberts Space Industries\StarCitizen\LIVE\Data.p4k", r"Data\Objects\buildingsets\hangar\deluxe\deluxe_elevator_shaft_02m.cgfm");
