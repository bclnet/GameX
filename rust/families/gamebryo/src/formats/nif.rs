// PORT-SOURCE: Families/GameX.Gamebryo/Formats/Nif.cs
// PORT-SHA: 819ee5fa3e230c82
// PORT-STATUS: done
// PORT-GENERATED: gen_enums.py — do not hand-edit; regenerate instead.
//
// 58 enum(s), 757 members, generated from the C#
...
//   StencilCompareMode                 u32   enum          8 members
//   StencilAction                      u32   enum          6 members
//   StencilDrawMode                    u32   enum          4 members
...
/// C# `enum StencilCompareMode : u32`.
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum StencilCompareMode {
    TEST_NEVER = 0x0,
    TEST_LESS = 0x1,
    TEST_EQUAL = 0x2,
    TEST_LESS_EQUAL = 0x3,
    TEST_GREATER = 0x4,
    TEST_NOT_EQUAL = 0x5,
    TEST_GREATER_EQUAL = 0x6,
    TEST_ALWAYS = 0x7, // Always true. Buffer is ignored.
}

impl StencilCompareMode {
    /// Decode from the on-disk value. `None` for anything undefined —
    /// a C-style cast would produce a value outside the enum, which is UB.
    pub fn from_raw(v: u32) -> Option<Self> {
        Some(match v {
            ...
            0x1 => Self::TEST_LESS,
            0x2 => Self::TEST_EQUAL,
            0x3 => Self::TEST_LESS_EQUAL,
            0x4 => Self::TEST_GREATER,
            0x5 => Self::TEST_NOT_EQUAL,
            0x6 => Self::TEST_GREATER_EQUAL,
            0x7 => Self::TEST_ALWAYS,
            _ => return None,
        })
    }
    /// The on-disk value.
...
pub enum StencilAction {
    ...
    ACTION_INVERT = 0x5, // Bitwise invert the value in the stencil buffer.
}
...
impl StencilAction {
    ...
    pub fn from_raw(v: u32) -> Option<Self> {
        Some(match v {
            0x0 => Self::ACTION_KEEP,
            0x1 => Self::ACTION_ZERO,
            0x2 => Self::ACTION_REPLACE,
            0x3 => Self::ACTION_INCREMENT,
            0x4 => Self::ACTION_DECREMENT,
            0x5 => Self::ACTION_INVERT,
            _ => return None,
        })
    }
    /// The on-disk value.
...
pub enum StencilDrawMode {
    ...
    DRAW_CCW = 0x1,
    DRAW_CW = 0x2,
    DRAW_BOTH = 0x3, // Draw all triangles, regardless of orientation. (Effectively force double-sided)
}

impl StencilDrawMode {
    /// Decode from the on-disk value. `None` for anything undefined —
    /// a C-style cast would produce a value outside the enum, which is UB.
    pub fn from_raw(v: u32) -> Option<Self> {
        Some(match v {
            0x0 => Self::DRAW_CCW_OR_BOTH,
            0x1 => Self::DRAW_CCW,
            0x2 => Self::DRAW_CW,
            0x3 => Self::DRAW_BOTH,
            _ => return None,
